...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Book.goodreads_id'
        db.delete_column('ebooks_book', 'goodreads_id')

        # Adding field 'Book._metarating'
        db.add_column('ebooks_book', '_metarating', self.gf('django.db.models.fields.FloatField')(default=0.0), keep_default=False)

        # Adding field 'Book._goodreads_id'
        db.add_column('ebooks_book', '_goodreads_id', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Book.goodreads_id'
        db.add_column('ebooks_book', 'goodreads_id', self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True), keep_default=False)

        # Deleting field 'Book._metarating'
        db.delete_column('ebooks_book', '_metarating')

        # Deleting field 'Book._goodreads_id'
        db.delete_column('ebooks_book', '_goodreads_id')
    ...
    models = {
        ...
        'ebooks.book': {
            ...
            '_goodreads_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            '_metarating': ('django.db.models.fields.FloatField', [], {'default': '0.0'}),
        ...
        'ebooks.read': {
            ...
            'book': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ebooks.Book']"}),
            'create_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'date_read': ('django.db.models.fields.DateField', [], {'default': "'1970-01-01'"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
