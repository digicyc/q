...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Book.thumbnail'
        db.add_column('ebooks_book', 'thumbnail', self.gf('django.db.models.fields.files.ImageField')(default='', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Book.thumbnail'
        db.delete_column('ebooks_book', 'thumbnail')
