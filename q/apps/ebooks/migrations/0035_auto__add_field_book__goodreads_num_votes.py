...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Book._goodreads_num_votes'
        db.add_column('ebooks_book', '_goodreads_num_votes', self.gf('django.db.models.fields.PositiveIntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Book._goodreads_num_votes'
        db.delete_column('ebooks_book', '_goodreads_num_votes')
    ...
    models = {
        ...
        'ebooks.book': {
            ...
            '_goodreads_num_votes': ('django.db.models.fields.PositiveIntegerField', [], {}),
