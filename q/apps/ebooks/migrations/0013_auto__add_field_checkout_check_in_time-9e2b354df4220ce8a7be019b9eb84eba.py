...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CheckOut.check_in_time'
        db.add_column('ebooks_checkout', 'check_in_time', self.gf('django.db.models.fields.DateTimeField')(default=None, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CheckOut.check_in_time'
        db.delete_column('ebooks_checkout', 'check_in_time')
    ...
    models = {
        ...
        'ebooks.checkout': {
            ...
            'check_in_time': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True'}),
            'create_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
