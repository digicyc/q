...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_unique('ebooks_book', ['slug'])

        # Adding field 'Format.verified'
        db.add_column('ebooks_format', 'verified', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Removing unique constraint on 'Book', fields ['slug']
        db.delete_unique('ebooks_book', ['slug'])

        # Deleting field 'Format.verified'
        db.delete_column('ebooks_format', 'verified')
