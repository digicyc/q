...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Series'
        db.create_table('ebooks_series', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100, db_index=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(db_index=True, max_length=100, blank=True)),
        ))
        db.send_create_signal('ebooks', ['Series'])

        # Adding field 'Book.series'
        db.add_column('ebooks_book', 'series', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['ebooks.Series'], null=True, blank=True), keep_default=False)

        # Adding field 'Book.series_num'
        db.add_column('ebooks_book', 'series_num', self.gf('django.db.models.fields.IntegerField')(default=None, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'Series'
        db.delete_table('ebooks_series')

        # Deleting field 'Book.series'
        db.delete_column('ebooks_book', 'series_id')

        # Deleting field 'Book.series_num'
        db.delete_column('ebooks_book', 'series_num')
    ...
    models = {
        ...
        'ebooks.book': {
            ...
            'gid': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'unique': 'True', 'max_length': '20', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'isbn10': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'unique': 'True', 'max_length': '20', 'blank': 'True'}),
            'isbn13': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'unique': 'True', 'max_length': '20', 'blank': 'True'}),
