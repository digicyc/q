...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('ebooks_book', 'checked_out', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='checked_out', null=True, to=orm['ebooks.CheckOut']), keep_default=False)
    ...
    models = {
        ...
        'ebooks.book': {
            ...
            'checked_out': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'checked_out'", 'null': 'True', 'to': "orm['ebooks.CheckOut']"}),
