...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('ebooks_ownership', 'checked_out', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='checkout_to', null=True, to=orm['ebooks.CheckOut']), keep_default=False)
