...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('ebooks_ownership', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('book', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ebooks.Book'])),
        ))
        db.send_create_signal('ebooks', ['Ownership'])

        # Adding unique constraint on 'Ownership', fields ['user', 'book']
        db.create_unique('ebooks_ownership', ['user_id', 'book_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Ownership', fields ['user', 'book']
        db.delete_unique('ebooks_ownership', ['user_id', 'book_id'])

        # Deleting model 'Ownership'
        db.delete_table('ebooks_ownership')
    ...
    models = {
        ...
        'ebooks.book': {
            ...
            'owners': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'owners'", 'symmetrical': 'False', 'through': "orm['ebooks.Ownership']", 'to': "orm['auth.User']"}),
