...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('ebooks_ownership', 'checked_out', self.gf('django.db.models.fields.related.ForeignKey')(related_name='checkout_to', null=True, to=orm['auth.User'], blank=True), keep_default=False)

        # Adding field 'Book.checked_out'
        db.add_column('ebooks_book', 'checked_out', self.gf('django.db.models.fields.related.ForeignKey')(related_name='checked_out', null=True, to=orm['ebooks.CheckOut'], blank=True), keep_default=False)
