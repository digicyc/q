...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Book.published_year'
        db.delete_column('ebooks_book', 'published_year')

        # Adding field 'Book.published'
        db.add_column('ebooks_book', 'published', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Book.published_year'
        db.add_column('ebooks_book', 'published_year', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Deleting field 'Book.published'
        db.delete_column('ebooks_book', 'published')
    ...
    models = {
        ...
        'ebooks.book': {
            ...
            'checked_out': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'blank': 'True'}),
