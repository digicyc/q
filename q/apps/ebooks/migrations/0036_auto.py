...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Book', fields ['create_time']
        db.create_index('ebooks_book', ['create_time'])


    def backwards(self, orm):
        
        # Removing index on 'Book', fields ['create_time']
        db.delete_index('ebooks_book', ['create_time'])
