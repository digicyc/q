...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Format.uploaded_by'
        db.add_column('ebooks_format', 'uploaded_by', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Format.uploaded_by'
        db.delete_column('ebooks_format', 'uploaded_by_id')
