...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('ebooks_author', 'slug', self.gf('django.db.models.fields.SlugField')(default=None, max_length=105, unique=True, null=True, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Author.slug'
        db.delete_column('ebooks_author', 'slug')
    ...
    models = {
        ...
        'ebooks.author': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'default': 'None', 'max_length': '105', 'unique': 'True', 'null': 'True', 'db_index': 'True'})
        },
        'ebooks.book': {
            'Meta': {'object_name': 'Book'},
            '_goodreads_id': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0', 'db_index': 'True'}),
            '_goodreads_num_votes': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
