...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Book', fields ['isbn10']
        db.create_unique('ebooks_book', ['isbn10'])

        # Adding unique constraint on 'Book', fields ['isbn13']
        db.create_unique('ebooks_book', ['isbn13'])

        # Adding unique constraint on 'Book', fields ['gid']
        db.create_unique('ebooks_book', ['gid'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Book', fields ['gid']
        db.delete_unique('ebooks_book', ['gid'])

        # Removing unique constraint on 'Book', fields ['isbn13']
        db.delete_unique('ebooks_book', ['isbn13'])

        # Removing unique constraint on 'Book', fields ['isbn10']
        db.delete_unique('ebooks_book', ['isbn10'])
