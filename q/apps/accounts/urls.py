...
#handling comments
from ebooks.listeners import activity_stream_comment, clear_all_activity_steam_cache, clear_index_actstream_cache
...
comment_was_posted.connect(clear_index_actstream_cache)