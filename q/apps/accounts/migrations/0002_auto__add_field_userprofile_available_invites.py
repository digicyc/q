...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.available_invites'
        db.add_column('accounts_userprofile', 'available_invites', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.available_invites'
        db.delete_column('accounts_userprofile', 'available_invites')
