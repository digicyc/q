...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'InvitationKey.emailed_to'
        db.add_column('accounts_invitationkey', 'emailed_to', self.gf('django.db.models.fields.EmailField')(default='', max_length=40, blank=True), keep_default=False)

        # Adding field 'InvitationKey.sent_to'
        db.add_column('accounts_invitationkey', 'sent_to', self.gf('django.db.models.fields.CharField')(default='', max_length=40, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'InvitationKey.emailed_to'
        db.delete_column('accounts_invitationkey', 'emailed_to')

        # Deleting field 'InvitationKey.sent_to'
        db.delete_column('accounts_invitationkey', 'sent_to')
    ...
    models = {
        'accounts.invitationkey': {
            ...
            'emailed_to': ('django.db.models.fields.EmailField', [], {'default': "''", 'max_length': '40', 'blank': 'True'}),
            ...
            'sent_to': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '40', 'blank': 'True'})
        },
