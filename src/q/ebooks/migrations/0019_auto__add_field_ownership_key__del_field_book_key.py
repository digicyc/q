...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Ownership.key'
        db.add_column('ebooks_ownership', 'key', self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=30, blank=True), keep_default=False)

        # Deleting field 'Book.key'
        db.delete_column('ebooks_book', 'key')


    def backwards(self, orm):
        
        # Deleting field 'Ownership.key'
        db.delete_column('ebooks_ownership', 'key')

        # Adding field 'Book.key'
        db.add_column('ebooks_book', 'key', self.gf('django.db.models.fields.CharField')(blank=True, default=None, max_length=30, db_index=True), keep_default=False)
