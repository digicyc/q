...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('ebooks_checkout', 'book', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['ebooks.Ownership']), keep_default=False)
    ...
    models = {
        ...
        'ebooks.checkout': {
            ...
            'book': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ebooks.Ownership']"}),
            'create_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
