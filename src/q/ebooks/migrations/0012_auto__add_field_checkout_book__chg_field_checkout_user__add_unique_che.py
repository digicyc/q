...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CheckOut.book'
        db.add_column('ebooks_checkout', 'book', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ebooks.Ownership'], null=True), keep_default=False)

        # Changing field 'CheckOut.user'
        db.alter_column('ebooks_checkout', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

        # Adding unique constraint on 'CheckOut', fields ['book', 'user']
        db.create_unique('ebooks_checkout', ['book_id', 'user_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'CheckOut', fields ['book', 'user']
        db.delete_unique('ebooks_checkout', ['book_id', 'user_id'])

        # Deleting field 'CheckOut.book'
        db.delete_column('ebooks_checkout', 'book_id')

        # Changing field 'CheckOut.user'
        db.alter_column('ebooks_checkout', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
    ...
    models = {
        ...
        'ebooks.book': {
            ...
            'checked_out': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'checked_out'", 'null': 'True', 'to': "orm['auth.User']"}),
            ...
            'owners': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'owners'", 'blank': 'True', 'to': "orm['ebooks.Ownership']"}),
        ...
        'ebooks.ownership': {
            ...
            'checked_out': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'checkout_to'", 'null': 'True', 'to': "orm['auth.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
