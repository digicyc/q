...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Ownership.checked_out'
        db.add_column('ebooks_ownership', 'checked_out', self.gf('django.db.models.fields.related.ForeignKey')(related_name='checkout_to', null=True, to=orm['auth.User']), keep_default=False)

        # Adding M2M table for field owners on 'Book'
        db.create_table('ebooks_book_owners', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('book', models.ForeignKey(orm['ebooks.book'], null=False)),
            ('ownership', models.ForeignKey(orm['ebooks.ownership'], null=False))
        ))
        db.create_unique('ebooks_book_owners', ['book_id', 'ownership_id'])


    def backwards(self, orm):
        
        # Deleting field 'Ownership.checked_out'
        db.delete_column('ebooks_ownership', 'checked_out_id')

        # Removing M2M table for field owners on 'Book'
        db.delete_table('ebooks_book_owners')
    ...
    models = {
        ...
        'ebooks.book': {
            ...
            'owners': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'owners'", 'symmetrical': 'False', 'to': "orm['ebooks.Ownership']"}),
        ...
        'ebooks.checkout': {
            ...
            'book': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['ebooks.Book']", 'null': 'True', 'blank': 'True'}),
            'create_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'ebooks.ownership': {
            ...
            'checked_out': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'checkout_to'", 'null': 'True', 'to': "orm['auth.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
